                        ...
                        <AnimatePresence>
                          {menuFiltroAbierto && (
                            <motion.div 
                              ...
                              className={`absolute right-0 top-10 w-48 border shadow-xl rounded-2xl p-2 flex flex-col z-50 ${isDark ? 'bg-slate-900 border-slate-700' : 'bg-white border-slate-200'}`}
                            >
